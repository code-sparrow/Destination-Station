...
var restaurantData = {{ combined_data[2] }};
...
// Subway Lines layer
d3.json("/static/data/SubwayLines.geojson", function(data) {
...
d3.json("/static/data/SubwayStations.geojson", function(data) {
    // Creating a geoJSON layer with the retrieved data
    L.geoJson(data, {
...
// {"type":"Feature",
// "properties":{"name":"Astor Pl","url":"http://web.mta.info/nyct/service/","line":"4-6-6 Express","objectid":"1","notes":"4 nights, 6-all times, 6 Express-weekdays AM southbound, PM northbound"},
// "geometry":{"type":"Point","coordinates":[-73.99106999861966,40.73005400028978]}}
